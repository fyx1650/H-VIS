...
class SIREN(nn.Module):
    def __init__(self, latent_size=0, in_dim=3, decoder_hidden_dim=256, nl='sine', decoder_n_hidden_layers=4,
                 init_type='siren', sphere_init_params=[1.6, 0.1], udf=False, vae=False):
        super().__init__()
    ...
    def forward(self, mnfld_pnts=None, only_nonmnfld=False, latent=None):
